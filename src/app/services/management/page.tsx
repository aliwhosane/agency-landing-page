...
const ManagementPage = () => {
  return (
    <>
      ...
      <section className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-12 py-12">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          {Artists.map(
            ({ name, desc, image, profession, facebook, instagram }) => (
              <div
                key={name}
                className="group w-full bg-mint-default hover:bg-black-100 rounded-lg sahdow-lg overflow-hidden flex flex-col md:flex-row"
              >
                ...
                <div className="w-full md:w-3/5 text-left p-6 md:p-4 space-y-2">
                  <p className="text-xl text-black group-hover:text-white font-bold">
                    {name}
                  </p>
